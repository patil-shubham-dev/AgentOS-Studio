...
vi.mock("@/lib/agents/orchestrator", () => {
  const mockFn = async (_baseUrl: string, _apiKey: string, _model: string, _input: string, _history: any[], signal: AbortSignal, onToken: (t: string) => void) => {
  ...
  return { fastChatCompletion: mockFn }
})
