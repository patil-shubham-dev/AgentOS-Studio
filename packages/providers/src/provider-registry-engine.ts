...
import { ProviderSelector, type ProviderCatalogEntry } from "./provider-selector"
import { CapabilityNegotiator, type CapabilityRequest, type NegotiationResult, type ProviderModelCatalog } from "./capability-negotiation"
import type { SelectionRequest, SelectionDecision, SelectionScorer, SelectionContext } from "./provider-selection-types"
...
export class ProviderRegistry {
  ...
  constructor(scorers?: SelectionScorer[]) {
    this.selector = new ProviderSelector(scorers)
  ...
  selectProvider(request: SelectionRequest, context?: Partial<SelectionContext>): SelectionDecision {
    ...
    return this.selector.select(candidates, request, context)
  }
  ...
  getSelector(): ProviderSelector {
    return this.selector
  }

  getDecisionHistory(): SelectionDecision[] {
    return this.selector.getDecisionHistory()
  }
