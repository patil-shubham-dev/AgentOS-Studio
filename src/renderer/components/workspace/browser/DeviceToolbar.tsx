      ...
      <div className="px-2 py-1.5">
        ...
        <div className="flex items-center gap-1 flex-wrap">
          {PRESETS.map((p) => (
            <button
              ...
              className={cn(
                ...
                activePreset === p.name
                  ? PLATFORM_COLORS[p.platform ?? "desktop"] + " border-white/[0.08]"
          ...
          <button
            ...
            className={cn(
              "rounded px-2 py-1 text-[10px] transition-all",
              showCustom ? "text-blue-400 bg-blue-500/10" : "text-white/30 hover:text-white/60 hover:bg-white/[0.06]",
            )}
          >
            Custom
          </button>
          {activePreset && (
            <button
              ...
              className="ml-auto rounded p-1 text-white/30 hover:text-white/60 transition-all"
        ...
        {showCustom && (
          ...
          >
            <input
              ...
              placeholder="Width"
              className="w-16 h-6 rounded bg-white/[0.04] border border-white/[0.06] px-2 text-[10px] font-mono text-white/60 outline-none focus:border-blue-500/30 placeholder:text-white/15"
            />
            ...
            <button
              ...
              className="rounded px-2 py-1 text-[9px] text-blue-400 bg-blue-500/10 hover:bg-blue-500/20 transition-all"
            >
              Apply
            </button>
            <button
